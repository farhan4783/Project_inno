...
export default function Heritage() {
  ...
  return (
    <section id="heritage" className="py-16 md:py-24 relative overflow-hidden" ref={ref}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-20 mb-16 md:mb-24">
          ...
          >
            {/* ── PLACEHOLDER ─────────────────────────────────── */}
            {/* ADD: old shop photo or founder photo here           */}
            {/* Replace this div with an <img> once you have the   */}
            {/* photo. Recommended size: portrait (3:4 ratio).     */}
            {/* ─────────────────────────────────────────────────── */}
            <div className="relative aspect-[3/4] overflow-hidden bg-noir-card border border-gold/10 flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-gold/30 text-xs tracking-[0.2em] uppercase text-center px-6">
                Add: old shop photo<br />or founder photo here
              </p>
            </div>
